 ...
 */
public enum CustomDefaultFilter
{
    ...
    ssl(SslFilter.class),
    user(JsonUserFilter.class);

    private final Class<? extends Filter> filterClass;

    private CustomDefaultFilter(Class<? extends Filter> filterClass)
    {
    ...
    public static Map<String, Filter> createInstanceMap(FilterConfig config)
    {
        ...
        for (CustomDefaultFilter defaultFilter : values())
        {
