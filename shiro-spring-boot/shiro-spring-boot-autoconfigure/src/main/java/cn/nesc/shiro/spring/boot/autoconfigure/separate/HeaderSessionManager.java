...
{
    private static Logger log = LoggerFactory.getLogger(HeaderSessionManager.class);

    private final String X_AUTH_TOKEN = "sid";

    private String sessionId;

    public HeaderSessionManager(String sessionId)
    {
    ...
    private String getSessionIdHeaderValue(ServletRequest request, ServletResponse response)
    {
        ...
        else
        {
            ...
            String sessionId = httpRequest.getHeader(null == this.sessionId ? this.X_AUTH_TOKEN : this.sessionId);
            // 每次读取之后 都把当前的 sessionId 放入 response 中
            HttpServletResponse httpResponse = (HttpServletResponse) response;
            if (StringUtils.isNotEmpty(sessionId))
            {
                httpResponse.setHeader(null == this.sessionId ? this.X_AUTH_TOKEN : this.sessionId, sessionId);
    ...
    {
        response.setHeader(null == this.sessionId ? this.X_AUTH_TOKEN : this.sessionId, "deleteMe");
    }
    ...
    private void storeSessionId(Serializable currentId, HttpServletRequest ignored, HttpServletResponse response)
    {
        ...
        else
        {
            ...
            response.setHeader(null == this.sessionId ? this.X_AUTH_TOKEN : this.sessionId, idString);
